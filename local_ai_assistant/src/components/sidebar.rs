    ...
    rsx! {
        aside {
            ...
            div {
                ...
                // Content Package panel button
                button {
                    class: if matches!(active_panel(), ActivePanel::ContentPackage) {
                        "w-full py-2 px-3 bg-blue-600 rounded-lg flex items-center gap-3 transition-colors mb-2"
                    } else {
                        "w-full py-2 px-3 hover:bg-slate-700 rounded-lg flex items-center gap-3 transition-colors mb-2"
                    },
                    onclick: move |_| on_select_panel.call(ActivePanel::ContentPackage),
                    svg {
                        class: "w-5 h-5 text-slate-400",
                        fill: "none",
                        stroke: "currentColor",
                    ...
                    span { "Content Package" }
                    span { class: "text-xs text-blue-400 ml-auto", "NEW" }
                }

                // SEO Analyzer panel button
                button {
                    class: if matches!(active_panel(), ActivePanel::SeoAnalyzer) {
                        "w-full py-2 px-3 bg-green-600 rounded-lg flex items-center gap-3 transition-colors mb-2"
                    } else {
                        "w-full py-2 px-3 hover:bg-slate-700 rounded-lg flex items-center gap-3 transition-colors mb-2"
                    },
                    onclick: move |_| on_select_panel.call(ActivePanel::SeoAnalyzer),
                    svg {
                        class: "w-5 h-5 text-slate-400",
                        fill: "none",
                        stroke: "currentColor",
                    ...
                    span { "SEO Analyzer" }
                    span { class: "text-xs text-green-400 ml-auto", "NEW" }
                }
            }
